...
app.use(
  cors({
    origin: [process.env.FRONTEND_URL, "http://localhost:5173", "https://www.odafodontologia.com"],
    credentials: true,
  }),
)
// Rate limiting
...
app.use("/api/usuarios-pacientes", require("./routes/usuarios-pacientes"))
...
app.use("/api/procedimientos", require("./routes/procedimientos"))
...
app.use("/procedimientos", require("./routes/procedimientos"))
